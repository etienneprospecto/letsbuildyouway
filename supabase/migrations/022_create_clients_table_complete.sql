-- Création de la table clients complète pour l'interface coach
...
CREATE INDEX IF NOT EXISTS idx_clients_progress ON public.clients(progress_percentage);
...
DO $$
BEGIN
  RAISE LOG 'Created complete clients table with sample data';
END $$;
