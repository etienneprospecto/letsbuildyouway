...
serve(async (req) => {
  ...
  try {
    const { email, name, invitationUrl } = await req.json()
      ...
      body: JSON.stringify({
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <a href="${invitationUrl}" style="background: #2563eb; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; display: inline-block; margin: 20px 0;">
              Créer mon compte
            </a>
