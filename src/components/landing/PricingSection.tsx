...
const pricingPlans = [
  {
    ...
    features: [
      { name: "Jusqu'à 10 clients", included: true },
      { name: "Programmes d'entraînement", included: true },
      { name: "Suivi des progrès", included: true },
      { name: "Messagerie intégrée", included: true },
      { name: "Support email", included: true },
      { name: "Rapports mensuels", included: false },
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {pricingPlans.map((plan, index) => (
            <Card
              key={index}
              className={`group relative overflow-hidden transition-all duration-700 transform hover:scale-105 hover:-translate-y-2 ${
                plan.popular 
            ...
            >
              ...
              <CardContent className={`relative z-10 p-8 ${plan.popular ? 'pt-12' : ''} group-hover:bg-gradient-to-br group-hover:from-white/5 group-hover:to-transparent transition-all duration-500`}>
                {/* Plan Header */}
