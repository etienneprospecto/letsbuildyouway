...
interface OptimizedFeedbackFormProps {
...
const OptimizedFeedbackForm: React.FC<OptimizedFeedbackFormProps> = ({
  template,
  onSubmit,
  loading = false,
  initialResponses = {}
              ...
              <div className="flex items-center space-x-4">
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    onChange={(e) => handleResponseChange(question.id, e.target.checked ? 'yes' : 'no')}
                    className="h-4 w-4 text-primary focus:ring-primary border-gray-300 rounded"
                  />
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            >
              {showProgress ? 'Masquer' : 'Afficher'} progression
            </Button>
          </div>
        </CardHeader>
        {showProgress && (
...
export default OptimizedFeedbackForm
