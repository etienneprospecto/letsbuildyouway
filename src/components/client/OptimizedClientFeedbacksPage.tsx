...
const OptimizedClientFeedbacksPage: React.FC = () => {
  const { user } = useAuth()
  const { 
    currentWeekStart, 
    goToPreviousWeek, 
      ...
      {showForm && currentTemplate && currentFeedback && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <motion.div
            ...
            className="bg-background rounded-lg shadow-lg max-w-4xl max-h-[95vh] overflow-hidden w-full"
          >
...
export default OptimizedClientFeedbacksPage
